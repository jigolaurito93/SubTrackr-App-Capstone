...
class PostForm(FlaskForm):
    subscription = SelectField('Name of Subscription', validators=[InputRequired()], choices=[('Choose Subscription..','Choose Subscription..'),('Amazon Prime', 'Amazon Prime'), ('Audible', 'Audible'), ('Costco', 'Costco'), ('Disney+', 'Disney+'), ('DoorDash', 'DoorDash'), ('Electricity', 'Electricity'), ('HBO Max', 'HBO Max'), ('Hello Fresh', 'Hello Fresh'), ('Hulu', 'Hulu'), ('Netflix', 'Netflix'), ('Pandora', 'Pandora'), ('Playstation Plus', 'Playstation Plus'), ('Rent', 'Rent'), ('Spotify', 'Spotify'), ('Uber', 'Uber'), ('Youtube Premium', 'Youtube Premium'), ('other', 'other')])
